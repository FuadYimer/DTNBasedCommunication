...
package org.disrupted.ibits.network.linklayer.wifi.UDP;

import android.net.wifi.WifiManager;
import org.disrupted.ibits.util.Log;

import org.disrupted.ibits.network.linklayer.LinkLayerNeighbour;
import org.disrupted.ibits.network.linklayer.MulticastConnection;
...
import org.disrupted.ibits.network.linklayer.wifi.WifiUtil;
...
public class UDPMulticastConnection implements MulticastConnection {
    ...
    public UDPMulticastConnection(int port, String address) {
        ...
        multicastLock = WifiUtil.getWifiManager().createMulticastLock("org.disruptedsystems.ibits.port."+udpPort);
    }
